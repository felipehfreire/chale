package br.com.chaledosventos.entidades;
...
//		if (!Util.verificaCampoVazio(qtdEstoque)) {
//			this.qtdEstoque = new Integer(qtdEstoque);
//		} else {
...
//		if (!Util.verificaCampoVazio(preco)) {
...
//		if (!Util.verificaCampoVazio(qtdMinEstoque)) {
//			this.qtdMinEstoque = new Integer(qtdMinEstoque);
//		} else {
//			this.qtdMinEstoque = null;
//		}
//		
//	}
